...
<body>
    ...
    <aside>
      <div class="top">
        <div class="logo">
          <h2>Dairy <span class="danger"> Farm</span></h2>
        </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Total Porters</h5>
                        <p class="card-text"><?php echo $totalPorters; ?></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text"><?php echo $totalDeliveries; ?></p>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
